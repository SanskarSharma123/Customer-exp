...
- specific_product_details → "User wants  specifications, features, or descriptions of a particular product by its  name or identifier."
- category_min_max_browsing -> "User is searching for products within a specific category, filtered by price range or other attributes."
